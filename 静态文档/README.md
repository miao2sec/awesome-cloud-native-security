...
105. Kubernetes RBAC：改善 K8s 的安全态势
...
104. .A beginners guide to contributing to CNCF open source projects（初学者参与CNCF开源项目的指南）
...
103. Making Sense of Kubernetes Initial Access Vectors（理解Kubernetes初始访问向量）
...
102. Kubernetes Audit Log “Gotchas”（解决Kubernetes审计日志的挑战）
...
101. GitHubActions & 阿里云解决国内镜像拉取问题
...
100. 深入可观测：基于 eBPF 构建下一代容器全栈观测的实践
...
98. EMERALDWHALE黑客组织窃取15000+云凭据
...
97. TeamTNT 的 Docker Gatling Gun 战役
...
95. AWS CDK 风险：利用缺失的 S3 存储桶实现账户接管
...
94. CVE-2024-9486 和 CVE-2024-9594：K8S Image Builder 构建的 VM 镜像使用默认凭证
...
93. 使用 gRPC 和 HTTP/2 部署加密货币挖矿机：一种非常规方法
...
92. 攻击者利用 perfctl 恶意软件攻击暴露的 Docker 远程 API 服务器
...
89. 趋势科技 Cloud Edge 漏洞可让攻击者执行任意代码
...
88. 朝鲜 ScarCruft 黑客组织利用 Windows 0day漏洞传播 RokRAT 恶意软件
...
87. 假的 LockBit，真实的损害：勒索软件样本滥用 Amazon S3 窃取数据
...
83. JFrog Integrates Runtime Security for Enhanced DevSecOps Platform
...
81. PoC Exploit Releases for CVE-2023-52447: A Linux Kernel Flaw Enabling Container Escape
...
80. Cloudflare Thwarts Largest-Ever 3.8 Tbps DDoS Attack Targeting Global Sectors
...
79. Hunting for M365 Password Spraying
...
78. Kicking it Old-School with Time-Based Enumeration in Azure
...
77.  perfctl: A Stealthy Malware Targeting Millions of Linux Servers
...
76. Western Digital My Cloud Devices Flaw Let Attackers Execute Arbitrary Code
...
75. Storm-0501 Ransomware Group Attacking Hybrid Cloud Environments
...
74. CloudImposer: Executing Code on Millions of Google Servers with a Single Malicious Package
...
73. Threat Actors leverage Docker Swarm and Kubernetes to mine cryptocurrency at scale
...
72. Tracking cloud-fluent threat actors - Part one: Atomic cloud IOCs
...
71. The Russian APT Tool Matrix（俄罗斯APT使用的工具矩阵）
...
70. Vulnerabilities in Open Source C2 Frameworks(开源C2框架中的漏洞)
...
69. The Cloud is Darker and More Full of Terrors
...
67. Noisy Neighbor Detection with eBPF——基于eBPF的噪声邻居检测
...
66. Ransomware in the Cloud: Scattered Spider Targeting Insurance and Financial Industries
...
65. Kubernetes CRD generation pitfalls
...
64. Cobalt Strike - CDN / Reverse Proxy Setup
...
63. Defining Reachability - is it just hype?
...
62. How Container Networking Works: a Docker Bridge Network From Scratch：
...
61. SeamlessPass: Leveraging Kerberos Tickets to Access the Cloud
...
58. CVE-2024-43044的分析：Jenkins通过agent文件读取到RCE
...
56. ShinyHunters勒索软件的探究（针对AWS进行攻击）
...
54. Kanister默认Kanister-Operator权限提升漏洞(CVE-2024-43403)
...
47. Grand Theft Actions: Abusing Self-Hosted GitHub Runners at Scale
...
46. CVE-2024-7646：Ingress-nginx注释验证绕过
...
45. 利用gitRepo volumes创建权限如何拿下K8s节点root权限
...
40. 容器逃逸：云环境中的逃逸技术(来自Palo Alto博客)
...
39. 启用安全防护：使用 CDK for Terraform 实现基础设施即代码
...
38. Binary secret scanning helped us prevent (what might have been) the worst supply chain attack you can imagine
...
36. Reverse Engineering eBPF Programs: A Deep Dive
...
30. 腾讯云对象存储COS（Cloud Object Storage）攻防
...
27. Buildkit 构建时容器清理任意删除（CVE-2024-23652）
- 📅 日期：2024-01-31
...
25. MITRE 的 Container ATT&CK 攻防矩阵 v14.1-v15.1
...
24. MITRE 的 Container ATT&CK 攻防矩阵 v13.1
...
22. NSA 需要强大的 Kubernetes 身份验证和授权
...
21. MITRE 的 Container ATT&CK 攻防矩阵 v12.1
...
20. 攻击者能够迅速利用著名的零日漏洞：2022年Unit 42事件响应报告见解
...
19. MITRE 的 Container ATT&CK 攻防矩阵 v11.3
